...
final localizedNews = {
  'de': [
    NewsItem(
      ...
      icon: AppIcon(IconService.brush, color: CustomTheme.primaryColor),
    ),
    NewsItem(
      title: 'Auswertung',
    ...
    NewsItem(
      ...
      icon: AppIcon(IconService.players, color: CustomTheme.primaryColor),
    ),
    NewsItem(
      ...
      icon: AppIcon(IconService.tool, color: CustomTheme.primaryColor),
    ),
  ],
  'en': [
    NewsItem(
    ...
    NewsItem(
      ...
      icon: AppIcon(IconService.player, color: CustomTheme.primaryColor),
    ),
